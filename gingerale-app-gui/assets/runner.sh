...
echo "TACC: Your DCV session is now running!" > $STOCKYARD/GingerALE_dcvserver.txt
echo "TACC: To connect to your DCV session, please point a modern web browser to:" >> $STOCKYARD/GingerALE_dcvserver.txt
echo "TACC:          https://stampede2.tacc.utexas.edu:$LOGIN_VNC_PORT" >> $STOCKYARD/GingerALE_dcvserver.txt
...
DISPLAY=:0 xterm -r -ls -geometry 80x24+10+10 -title '*** Exit this window to kill your DCV server ***' -e 'singularity exec docker://${CONTAINER_IMAGE} java -jar /app/GingerALE.jar'
