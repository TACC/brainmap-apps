...
function runALE_on_perExpTxtFile_dir(txt_dir,gtm_folder_path,std_space)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Z_folder_path      = strcat(gtm_folder_path,'MA_Z');
...
if     nargin < 3,                std_space = 'MNI'; fprintf('No standard space specified. Default: MNI\n');
elseif nargin < 2,                error('Not enough input argments. Please specify a directory as the first input parameter.\n'); end
...
fprintf('My txt_dir_s %s\n', txt_dir_s);
fprintf('My txt_dir_s_txt %s\n', txt_dir);
...
copyfile(output_z_files_dir,    Z_folder_path)
