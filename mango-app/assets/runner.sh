...
echo "TACC: Your DCV session is now running!" > $STOCKYARD/Mango_dcvserver.txt
echo "TACC: To connect to your DCV session, please point a modern web browser to:" >> $STOCKYARD/Mango_dcvserver.txt
echo "TACC:          https://stampede2.tacc.utexas.edu:$LOGIN_VNC_PORT" >> $STOCKYARD/Mango_dcvserver.txt
...
DISPLAY=:0 xterm -r -ls -geometry 80x24+10+10 -title '*** Exit this window to kill your DCV server ***' -e 'singularity exec docker://${CONTAINER_IMAGE} /Mango/mango'
...
echo "TACC: job $SLURM_JOB_ID execution finished at: `date`"
rm $STOCKYARD/Mango_dcvserver.txt
