...
echo "TACC:          https://ls6.tacc.utexas.edu:$LOGIN_PORT" >> $STOCKYARD/Mango_dcvserver.txt
...
sleep 1
DISPLAY=:0 xterm -ls -geometry 80x24+100+50 -e 'singularity exec docker://${CONTAINER_IMAGE} /Mango/mango' &
