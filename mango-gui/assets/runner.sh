...
singularity exec docker://${CONTAINER_IMAGE} cp /app/Plugins/BehavioralAnalysis.jar /app/Plugins/DiseaseAnalysis.jar /app/Plugins/ParadigmAnalysis.jar $HOME/Mango/Plugins/
