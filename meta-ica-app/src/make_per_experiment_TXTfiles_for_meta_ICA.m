%% make_per_experiment_TXTfiles_for_meta_ICA
...
%
function [outdir, std_space_in] = make_per_experiment_TXTfiles_for_meta_ICA(sleuth_text_file, folder_path, filter_0none_1exp_2pap)
%% Chunk 1
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
if filter_0none_1exp_2pap == 1 %experiment filter
    ...
    outdir = strcat(folder_path,'/','per-experiment_TXTfiles-expFilter');
elseif filter_0none_1exp_2pap == 2 %paper filter
    ...
    outdir = strcat(folder_path,'/','per-experiment_TXTfiles-papFilter');
else %no filter
    if ~exist('per-experiment_TXTfiles-noFilter', 'dir'), mkdir('per-experiment_TXTfiles-noFilter'); end
    outdir = strcat(folder_path,'/','per-experiment_TXTfiles-noFilter');
end
